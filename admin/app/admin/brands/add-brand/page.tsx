...
export default function AddBrandPage(): React.JSX.Element {
  ...
  // Auto-generate handle from brand name
  useEffect(() => {
    if (brandName) {
      const handle = generateHandle(brandName)
  ...
  return (
    <div className="px-4 md:px-8">
      ...
      <div className="mb-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            disabled={createBrandMutation.isPending || isUploading}
          ...
          >
            {isUploading ? "Uploading..." : createBrandMutation.isPending ? "Saving..." : "Save"}
          </button>
        </div>
      </div>
      ...
      <div className="rounded-xl border border-[#E5E7EB] bg-white p-6">
        ...
        <form id="add-brand-form" onSubmit={handleSubmit(onSubmit)}>
