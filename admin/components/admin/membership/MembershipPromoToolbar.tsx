...
type MembershipPromoToolbarProps = {
  searchQuery: string;
...
const statusFilterOptions = [
  ...
  { value: "active" as const, label: "Active", description: "Currently active promotions" },
  { value: "non-active" as const, label: "Inactive", description: "Disabled promotions" },
];

export function MembershipPromoToolbar({
  searchQuery,
  onSearchChange,
  statusFilter,
  onFilterChange,
  onAddClick,
}: MembershipPromoToolbarProps): React.JSX.Element {
  ...
  const getActiveFilterLabel = (): string => {
    ...
    return option?.label || "All Promos";
  };
    ...
    <div className="mb-6">
      <div className="flex flex-col items-stretch gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex flex-col items-stretch gap-2 sm:flex-row sm:items-center">
            ...
            {isFilterOpen && (
              <div className="absolute right-0 top-full z-50 mt-2 w-[280px] rounded-xl border border-[#E5E7EB] bg-white p-5 shadow-lg">
                ...
                <div className="mb-5 flex items-center justify-between">
                  <h3 className="font-geist text-[16px] font-semibold text-[#030712]">Filter Promos</h3>
                  <button
                ...
                <div className="mb-5">
                  <label className="mb-3 block font-geist text-[13px] font-medium text-[#374151]">Promo Status</label>
          ...
          {/* Add New Membership Promo Button */}
          <Button
            variant="primary"
            onClick={onAddClick}
            icon={
