    ...
    <main className="min-h-screen bg-[#FAFAFA] font-sans mt-14">
      ...
      <section className="max-w-3xl mx-auto px-6 py-16 md:py-24">
        ...
        <div className="space-y-10">
          ...
          <PolicySection title="Shipping options and costs" delay={0}>
            <p>
          ...
          {/* Shipping times */}
          <PolicySection title="Shipping times" delay={0.05}>
            <p>
          ...
          <PolicySection title="Shipping destinations" delay={0.1}>
            <p>
          ...
          {/* Order tracking */}
          <PolicySection title="Order tracking" delay={0.15}>
            <p>
          ...
          <PolicySection title="Handling damaged or lost orders" delay={0.2}>
            <p>
          ...
          <PolicySection title="Customs and import fees" delay={0.25}>
            <p>
