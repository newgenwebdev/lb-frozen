    ...
    <main className="min-h-screen bg-[#FAFAFA] font-sans mt-14">
      ...
      <section className="max-w-3xl mx-auto px-6 py-16 md:py-24">
        ...
        <div className="space-y-10">
          ...
          <PolicySection title="Collection of information" delay={0}>
            <p>
          ...
          {/* Use of your data */}
          <PolicySection title="Use of your data" delay={0.05}>
            <p>
          ...
          <PolicySection title="Sharing and disclosure" delay={0.1}>
            <p>
          ...
          {/* Data security */}
          <PolicySection title="Data security" delay={0.15}>
            <p>
          ...
          <PolicySection title="Your rights and choices" delay={0.2}>
            <p>
          ...
          <PolicySection title="Cookies and tracking" delay={0.25}>
            <p>
