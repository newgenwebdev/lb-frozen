...
export default function ReturnPolicyPage(): React.JSX.Element {
      ...
      <main className="min-h-screen bg-[#FAFAFA] font-sans mt-14">
        ...
        <section className="max-w-3xl mx-auto px-6 py-16 md:py-24">
          ...
          <div className="space-y-10">
            ...
            <PolicySection title="Eligibility for returns" delay={0}>
              <p>
            ...
            <PolicySection title="How to initiate a return" delay={0.05}>
              <p>
            ...
            {/* Refund process */}
            <PolicySection title="Refund process" delay={0.1}>
              <p>
            ...
            <PolicySection title="Non-returnable items" delay={0.15}>
              <p>
            ...
            <PolicySection title="Damaged or incorrect items" delay={0.2}>
              <p>
            ...
            <PolicySection title="Shipping costs for returns" delay={0.25}>
              <p>
